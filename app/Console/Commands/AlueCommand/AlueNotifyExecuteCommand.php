...
class AlueNotifyExecuteCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'AlueCommand:notifyExecute {runType=null}';
    protected $commandName = 'AlueCommand:notifyExecute';
     ...
     * @var string
     */
    protected $description = 'Parental Command Of Notify Execute';
    ...
    public function handle()
    {
        ...
        $command = "AlueBatchCommand:notifyExecute " . $runType;
