...
class AlueImportJsonCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'AlueCommand:importJson {runType=null}';
    protected $commandName = 'AlueCommand:importJson';
     ...
     * @var string
     */
    protected $description = 'Parental Command Of Import Json';
    ...
    public function handle()
    {
        ...
        $command = "AlueBatchCommand:importJson " . $runType;
