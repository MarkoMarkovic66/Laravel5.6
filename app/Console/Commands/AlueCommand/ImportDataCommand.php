...
use App\Services\AlueCommandService\AlueIntegDataImportService;
...
class ImportDataCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'AlueBatchCommand:importData {runType=null}';
    protected $commandName = 'AlueBatchCommand:importData';
     ...
     * @return void
     */
    public function __construct(AlueIntegDataImportService $alueIntegDataImportService)
    {
        parent::__construct();
        $this->initAlueCommandLogTrait('console/importData.log');
        $this->alueIntegDataImportService = $alueIntegDataImportService;
    }
    ...
    public function handle()
    {
        ...
        try {
            ...
            //バッチ処理の実行
            $resultMessage = '';
            $ret = $this->alueIntegDataImportService->exec($resultMessage);
