...
class CreateQuestionCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'AlueBatchCommand:createQuestion {runType=null}';
    protected $commandName = 'AlueBatchCommand:createQuestion';
     ...
     * @var string
     */
    protected $description = 'Create Question Batch Command';
    ...
    public function handle()
    {
        ...
        try {
            ...
            //バッチ処理の実行
            $resultMessage = '';
            $ret = $this->alueIntegCreateQuestionService->exec($resultMessage);
