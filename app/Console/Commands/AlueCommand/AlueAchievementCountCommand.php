...
class AlueAchievementCountCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'AlueCommand:achievementCount {runType=null}';
    protected $commandName = 'AlueCommand:achievementCount';
     ...
     * @var string
     */
    protected $description = 'Parental Command Of Countup Member Achievement';
    ...
    public function handle()
    {
        ...
        $command = "AlueBatchCommand:achievementCount " . $runType;
