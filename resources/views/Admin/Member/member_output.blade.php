            ...
            <div class="primary-hero-box">
              <div class="hero-section">
                <div class="secondary-item">
                  <span>会員管理TOP > {{$memberName}}さんの詳細 > OUTPUT履歴</span>
                </div>
                ...
                <div class="secondary-box">
                  <div class="hwork-item">
                    <div class="hwork-top-item-box detail-history-item">
                  ...
                  <div class="hwork-top-item-box detail-history-item">
                    ...
                    <div class="master-item-edit">
                      <div class="btn btn-domain" data-toggle="modal" data-target="#editPolicyModal">詳細</div>
                    </div>
                  </div>
                  <div class="hwork-top-item-box detail-history-item">
                    <div class="hwork-master-item-id master-item">
...
@endsection
@section('scripts')
<script src="{{ mix('/js/member_output.js') }}"></script>
@endsection
